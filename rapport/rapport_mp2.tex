...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\setlength{\fboxsep}{4pt}\setlength{\fboxrule}{0.4pt}\fbox{\includegraphics[width=0.65\linewidth,keepaspectratio]{screenshots/logo.png}}}
...
\begin{itemize}[nosep,leftmargin=1.2em]
  ...
  \item Durcissement complet : SSH port 2222 + MFA TOTP, UFW, OpenLDAP, fail2ban, GPG saves
...
Avant toute implementation dans GNS3, nous avons concu un schema logique de l'infrastructure cible. Ce schema nous a servi de reference du projet pour verifier la coherence des flux et des zones de securite.
...
Pour structurer notre infrastructure, nous avons opte pour un modele de securite en zones -- chaque zone etant isolee par pfSense et ne pouvant communiquer avec les autres que via des regles de filtrage. Ce choix nous permet de limiter la portee d'une compromission : si un poste employe est infecte, l'attaquant ne peut pas atteindre les serveurs internes ou la zone d'administration sans franchir plusieurs couches de filtrage.
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/pfsense-suricata-available.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/pfsense-suricata-installing.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/pfsense-suricata-started.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/alerts-tab.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/ssh-login.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/google auth.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/elk-browser.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/elk-index-management.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/elk-data-view.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{screenshots/elk-discover.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/firewall-rules-example.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/fail2ban.png}}}
...
\begin{figure}[H]
  \centering
  {\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.4pt}
  \fbox{\includegraphics[width=0.90\linewidth,keepaspectratio]{real-results/ufw-block.png}}}
